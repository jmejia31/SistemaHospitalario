...
namespace App\Http\Controllers\Personas\Pacientes;
...
class PacientesController extends Controller
{
    ...
    public function index()
    {
        ...
        //   dd($categorias->body());
            ...
            return view('Personas.Pacientes.Pacientes',compact('PaciArray'));
    }
  ...
  //
    ...
    public function edit($id)
    {
        ...
        return view('Personas.Pacientes.pacienteEdit', ['infopaciente' => json_decode($cuerpo)]);
