...
uuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu --}}
    <div class="container outer-section-responsive" >

       <form class="form-horizontal" role="form" id="datos_factura" method="post">
        <div id="print-area">
                  <div class="row pad-top font-big">
                <div class="col-lg-4 col-md-4 col-sm-4">
                  <a href="https://obedalvarado.pw/" target="_blank">  </a>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <strong>E-mail : </strong> sistemahospitalariohn@gmail</br>
                    <br />
                    <strong>Teléfono :</strong> 27836789 <br />
					<strong>Sitio web :</strong> https://sistemahospitalariohn.com/

                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <strong><?php echo $rw['nombre_comercial'];?>  </strong>
                    <br />
                    Dirección : col. Villa nueva Cortes
                </div>
            ...
            <div class="container">
                <div >
                    {{-- <div class="table-responsive">
                        <a class="btn btn-success" href="{{ url('facturas/create') }}">Agregar nueva factura <span
                        ...
                        <table id="registros" class="table table-sm table-striped table-hover table-bordered">
                            <thead style="background-color: #3b83bd;color: white; font-weight: bold;">
                                <tr>
                                    ...
                                    <th>Codigo de metodo de pago</th> --}}
                            ...
                            @foreach ($fac [0] as $factura )
                                <tr>
                                    {{-- <td>{{$factura->COD_FACTURA}}</td> --}}
                                    {{-- <td>{{$factura->COD_PACIENTE}}</td>
                                    <td>{{$factura->COD_SERVICIO}}</td>
                                    <td>{{$factura->COD_METODO_PAGO}}</td> --}}
                                    ...
                                    <td>
                                        <a class="btn btn-warning"
                                            href="{{ url('facturas/' .$factura->COD_FACTURA. '/edit') }}">Editar</a>
                                    </td>
                                    {{-- <td>
                                    ...
                                    <td>
                                        <form method="post" action="{{ url('facturas', $factura->COD_FACTURA) }}">
                                            @csrf()
                                            @method('DELETE')
